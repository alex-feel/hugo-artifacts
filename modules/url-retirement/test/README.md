...
Build-output assertions over the two documents this module publishes. The runner builds `./fixture` twelve times and the specs read the published bytes; nothing is mocked, and no assertion is made against a template.
