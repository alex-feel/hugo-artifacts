...
modules/seo/
  ...
  test/                                    # Validation suite: a Hugo fixture site built twelve times (baseline, configured, subpath, badtypes, offswitch, multilingual, pagination, pagination-subpath, graph, sitename, generated, hometitle) plus Node build-output assertions. See test/README.md.
```
