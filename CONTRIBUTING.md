...
- **Node.js v22+** -- only needed if you are working on `modules/pwa`'s TypeScript service worker (compiled via `js.Build`) or running the project's existing ESLint setup.
